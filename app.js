...
function finishAssessment() {
  ...
  let attitudeResult = "";
  if (total >= 26) {
    attitudeResult = "ผ่านการทดสอบยอดเยี่ยม: ผู้สมัครนี้มีทัศนคติที่ดีในทุกด้าน";
  } else if (total >= 20) {
    attitudeResult = "ผ่านการทดสอบและพัฒนาบางทักษะ...";
  } else if (total >= 14) {
    attitudeResult = "ผ่านได้แต่ควรพัฒนา...";
  } else {
    attitudeResult = "ต้องพัฒนา...";
  }
  ...
  // กลุ่มขาย
  else if (pos.match(/tele|โทรขาย|telesales/)) {
    targetURL = "exam-telesales.html";
  }
  else if (pos.match(/sale|ขาย|ae|เซลล์|ฝ่ายขาย/)) {
